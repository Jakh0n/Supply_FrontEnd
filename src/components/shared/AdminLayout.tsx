...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
	...
	const MobileSidebarContent = () => (
		<div className='flex flex-col h-full'>
			...
			<div className='border-t px-4 py-4 flex-shrink-0 bg-white'>
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						<Button
							variant='ghost'
			...
			{isMobileMenuOpen && (
				<div className='fixed inset-0 z-50 lg:hidden'>
					<div
						...
						onClick={() => setIsMobileMenuOpen(false)}
					/>
					<div className='fixed left-0 top-0 bottom-0 w-72 max-w-[85vw] bg-white shadow-lg flex flex-col'>
						...
						{/* Mobile Sidebar Content - Full remaining height */}
