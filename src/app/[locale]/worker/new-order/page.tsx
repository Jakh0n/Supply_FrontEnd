    ...
    <ProtectedRoute requiredRole="worker">
      <DashboardLayout>
        <div className="space-y-4 sm:space-y-6">
          ...
          {!loading && <HolidayDayNotice requestedDate={requestedDate} />}
                                    ...
                                    <table className="w-full">
                                      ...
                                      <tbody>
                                        {productsInCategory.map((product) => {
                                          ...
                                          >
                                            <td className={`p-3 ${!available ? "opacity-60 blur-[1px]" : ""}`}>
                                            ...
                                            <td className={`p-3 text-sm text-gray-600 font-medium truncate ${!available ? "opacity-60 blur-[1px]" : ""}`}>
                                              {product.unit}
                                            </td>
                    ...
                    <div className="mt-2 sm:mt-3 text-center">
                      ...
                      orderItems.length === 0 ? (
                        <p className="text-xs text-gray-500 flex items-center justify-center space-x-1">
                          ...
                          <span>
                            {!orderBranch
                              ? "Invalid login account — contact an admin"
                              : !requestedDate
